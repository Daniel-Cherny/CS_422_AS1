...
var LOG_VERSION = "";       // Labels every entry with version: "B".
...
var timeToCreateEvent = () => {
  var newCurrentTime = toSeconds((new Date).getTime());
  $(document).trigger('log', ['timeToCreateEvent', {'timeToCreateEvent': (newCurrentTime - currentTime)}]);
  currentTime = newCurrentTime;
};

// number of times user clicks on 'starts' and 'ends' input fields

var numberOfStartClicks = 0;
var numberOfEndClicks = 0;

var incrementStartClicks = () => {
  numberOfStartClicks++;
}

var incrementEndClicks = () => {
  numberOfEndClicks++;
}

var totalCalendarClicks = () => {
  $(document).trigger('log', ['totalCalendarClicks', 
  {'totalCalendarClicks': (numberOfStartClicks + numberOfEndClicks)}]);
  numberOfStartClicks = 0;
  numberOfEndClicks = 0;
}
...
// curl -sL goo.gl/jUkahv | python3 - https://docs.google.com/forms/d/1zeUm43Gtln-CXNOJHFJbXTs2dhBDfq5uty7X_0AfI2E/edit
//
...
// docs.google.com/forms/d/1zeUm43Gtln-CXNOJHFJbXTs2dhBDfq5uty7X_0AfI2E/edit
function sendNetworkLog(
  ...
  state,
  version) {
  var formid = "e/1FAIpQLSfT8kbyvz0mCViGOkQvOkIxXcW-cqAUdKPBYoEKrQluKdqjYQ";
  var data = {
    "entry.1353495835": uid,
    "entry.2142325583": time,
    "entry.1269620532": name,
    "entry.176399871": target,
    "entry.188860112": info,
    "entry.1144400881": state,
    "entry.910650829": version
  };
  var params = [];
  for (key in data) {
